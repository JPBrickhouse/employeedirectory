...
class App extends Component {
  ...
  firstFilterChange = event => {
    ...
    this.setState(
      {
        firstFilterSelected: event.target.value,
        listOfEmployeesDisplayed: []
      }, this.secondFilterContent)
  }
  ...
  secondFilterContent = () => {
    ...
    // Otherwise, generate the content to place into the secondFilterDropdown
      ...
      // Sorting the entries in the second dropdown
      // - Sort works on strings and sorts them alphabetically
      dropdownNoDuplicates.sort();
    ...
    return (
      <div>
        <div style={{textAlign: 'center' }}>
          {/* Title Block */}
          <h1 style={{padding: '1%', border: '3px solid blue'}}>Employee Directory - Disney Style!</h1>

          {/* First Filter */}
          <div style={{ display: 'inline-block', textAlign: 'center', padding: '1%', border: '1.5px solid blue'}}>
            <h3>Filter by</h3>
